...
In a more complicated application, you might want to apply techniques covered in the *Splitting Bundles* chapter across the pages. Dropping the multi-compiler mode can be worthwhile then.
