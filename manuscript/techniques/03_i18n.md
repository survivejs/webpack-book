...
To illustrate the setup, _embed-i18n-webpack-plugin_ is a good starting point.
...
Install _embed-i18n-webpack-plugin_ and _glob_ helper first. The latter is needed for capturing translation files.

```bash
npm add glob embed-i18n-webpack-plugin -D
```
