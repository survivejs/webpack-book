...
The first `module` parameter contains a more than just `context`. If you wanted to figure out how many times a specific module is included in the chunks generated by webpack, you could check `module.chunks.length`. This is useful especially if you want more control when code splitting is used.
