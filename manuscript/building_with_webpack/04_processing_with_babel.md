...
Connecting Babel with a project allows you to process webpack configuration through Babel if you name your webpack configuration following *webpack.config.babel.js* convention. This works with other solutions too as it relies on a package known as [interpret](https://www.npmjs.com/package/interpret). Given that [Node.js supports the ES6 specification well](http://node.green/) these days, you can use a lot of features without the overhead, though.
