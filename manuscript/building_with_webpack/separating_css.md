...
Hash: 767d9c24be731e1e2986
Version: webpack 1.13.0
Time: 5884ms
                           Asset       Size  Chunks             Chunk Names
     app.ee7cdcb255609569a291.js  201 bytes    0, 3  [emitted]  app
   style.162c821b300944ebf177.js  105 bytes    1, 3  [emitted]  style
  vendor.05a555881b4c125d77fc.js     131 kB    2, 3  [emitted]  vendor
manifest.f4da8ddf4b5cde1aec15.js  788 bytes       3  [emitted]  manifest
  style.162c821b300944ebf177.css    16.6 kB    1, 3  [emitted]  style
                      index.html  402 bytes          [emitted]
   [0] ./app/index.js 100 bytes {0} [built]
   [0] multi vendor 28 bytes {2} [built]
...
As you can see, `style.162c821b300944ebf177.css` grew from 24 bytes to 16.6 kB as it should have. Also the hash changed because the file contents changed as well.
...
```bash
[webpack-validator] Config is valid.
clean-webpack-plugin: /Users/juhovepsalainen/Projects/survivejs/webpack-demo/build has been removed.
Hash: 1a472edb198290f64321
Version: webpack 1.13.0
Time: 15023ms
                           Asset       Size  Chunks             Chunk Names
     app.5b2cac5b032b224df326.js  227 bytes    0, 3  [emitted]  app
   style.162c821b300944ebf177.js  105 bytes    1, 3  [emitted]  style
  vendor.05a555881b4c125d77fc.js     131 kB    2, 3  [emitted]  vendor
manifest.213d377483346fd46180.js  788 bytes       3  [emitted]  manifest
  style.162c821b300944ebf177.css    13.9 kB    1, 3  [emitted]  style
                      index.html  402 bytes          [emitted]
   [0] ./app/index.js 100 bytes {0} [built]
   [0] multi vendor 28 bytes {2} [built]
   [0] multi style 40 bytes {1} [built]
 [153] ./app/component.js 173 bytes {0} [built]
    + 158 hidden modules
Child html-webpack-plugin for "index.html":
        + 3 hidden modules
Child extract-text-webpack-plugin:
...
The size of our style went from 16.6 kB to 13.9 kB. It's not a huge difference in this case, but it's still something. It is interesting to note that processing time went from five seconds to fifteen so there is a cost involved! The technique is useful to know as it will likely come in handy with heavier CSS frameworks.
